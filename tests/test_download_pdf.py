...
def test_download_pdf():
    ...
    url = 'https://aplikacja.ceidg.gov.pl/CEIDG/CEIDG.Public.UI/SearchDetails.aspx?Id=5b1c3425-7863-4c80-a19e-d8d7bf65c971'

    try:
        sf.open_browser(url)
        sf.download_pdf('6770062655', 'C:\\Users\\fisher46109\\Documents\\TempCompanyCollector\\Output')
